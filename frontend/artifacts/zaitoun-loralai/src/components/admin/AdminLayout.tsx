...
import { LayoutDashboard, Package, ShoppingCart, MessageSquare, LogOut, Bell, Tag, Crown, Home, BookOpen, UtensilsCrossed, Star, Award, Wine, Truck } from "lucide-react";
        ...
        <SidebarContent>
          <SidebarGroup>
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/testimonials"}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/quality-features"}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/wholesale"}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/founder"}>
                  <a href="/admin/founder">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/homepage"}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={location === "/admin/story"}>
                  <a href="/admin/story">
